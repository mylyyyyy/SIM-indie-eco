...
<head>
    <meta charset="UTF-8">
    <title>Stok Beras di Toko</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <h2>LAPORAN STOK BERAS DI TOKO MITRA</h2>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="30%">Nama Toko Mitra</th>
                <th width="15%">Stok 2.5 Kg (Pack)</th>
                <th width="15%">Stok 5 Kg (Pack)</th>
            </tr>
        </thead>
        <tbody>
            @forelse($stocks as $index => $stock)
                <tr>
                    ...
                    <td class="text-left">{{ $stock->nama_admin }}</td>
                    <td class="text-left font-bold">{{ $stock->nama_toko }}</td>
                    <td style="font-weight: bold; color: #059669;">{{ number_format($stock->stok_2_5kg, 0, ',', '.') }}</td>
                    <td style="font-weight: bold; color: #2563eb;">{{ number_format($stock->stok_5kg, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" style="padding: 20px; color: #64748b; font-style: italic;">Belum ada data stok beras di toko.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
