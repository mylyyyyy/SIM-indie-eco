        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <form method="POST" action="{{ route('eco.portfolios.update', $portfolio->id) }}" enctype="multipart/form-data" class="p-8">
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
                    <a href="{{ route('eco.portfolios.index') }}" class="px-6 py-3 bg-white border border-slate-200 text-slate-600 rounded-xl text-sm font-bold hover:bg-slate-50 transition-colors">Batal</a>
