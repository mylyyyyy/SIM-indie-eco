<x-admin-layout>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 animate__animated animate__fadeInDown">
        ...
        <div class="flex gap-3 w-full md:w-auto">
            ...
            <a href="{{ route('indie.news.create') }}" 
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center items-center gap-2">
                                <a href="{{ route('indie.news.edit', $item->id_berita) }}" 
                                ...
                                <form id="delete-form-{{ $item->id_berita }}" action="{{ route('indie.news.destroy', $item->id_berita) }}" method="POST" class="hidden">
                                    @csrf @method('DELETE')
                                </form>
                            </div>
                        </td>
