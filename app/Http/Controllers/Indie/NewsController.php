...
class NewsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('indie.news.index', compact('berita'));
    }

    // Menampilkan Form Tambah
    public function create()
    {
        return view('indie.news.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('indie.news.index')->with('success', 'Berita berhasil diterbitkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('indie.news.edit', compact('berita'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('indie.news.index')->with('success', 'Berita berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('indie.news.index')->with('success', 'Berita berhasil dihapus!');
    }
}