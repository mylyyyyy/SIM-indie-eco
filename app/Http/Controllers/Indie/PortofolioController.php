...
class PortofolioController extends Controller
{
    public function index()
    {
        ...
        $portfolios = Portfolio::where('division', 'indie')->latest()->get();
        return view('indie.portfolios.index', compact('portfolios'));
    }

    public function edit($id)
    {
        $portfolio = Portfolio::findOrFail($id);
        return view('indie.portfolios.edit', compact('portfolio'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Portfolio::create([
            'title' => $request->title,
            'division' => 'indie', // Otomatis set divisi ECO
        ...
        return redirect()->route('indie.portfolios.index')->with('success', 'Data kegiatan berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('indie.portfolios.index')->with('success', 'Data kegiatan diperbarui!');
    }
